...
$remoteCmd = "echo 'dYt2295ZBM_EgUb' | sudo -S tar -xzvf /tmp/deploy_package.tar.gz -C /var/www/edvora.chat/ && rm -f /var/www/edvora.chat/public/app/tabs/department*.html /var/www/edvora.chat/public/app/tabs/dept-*.html /var/www/edvora.chat/public/app/js/departments.js && php /var/www/edvora.chat/migrate.php && echo 'dYt2295ZBM_EgUb' | sudo -S chown -R critical:www-data /var/www/edvora.chat && echo 'dYt2295ZBM_EgUb' | sudo -S systemctl reload apache2"
