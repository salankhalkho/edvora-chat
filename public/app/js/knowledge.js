...
// ═══════════════════════════════════════════════════════════════════
        ...
        function openReplaceKnowledgeModal(ksId) {
            ...
            document.getElementById('replaceOldCategory').innerText = item.category || 'Admissions';
            document.getElementById('replaceOldVersion').innerText = item.academic_version || '2025-26';
            document.getElementById('replaceOldExpiry').innerText = item.expires_on || 'None';
            ...
            document.getElementById('replaceTitleInput').value = item.title;
        ...
        function docEditorTriggerReplace() {
            if (!currentEditingDoc) return;
            openReplaceKnowledgeModal(currentEditingDoc.id);
        }
