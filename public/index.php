...
$router->get('/v1/knowledge/{id}/download', [KnowledgeController::class, 'download']);
...
// Dedicated Standalone LLM Logs Inspector (No Bloat in index.html)
$router->get('/llm-logs', function (Request $req) {
